...
public class OrderRepositoryTest {
    ...
    void findAllByUserId_ExistingUserId_ReturnsOrdersPage() {
        // When
        Page<Order> actual = orderRepository.findAllByUserId(4L, Pageable.ofSize(5));
        ...
        assertThat(actual.getContent())
                ...
                .allMatch(user -> user.getId().equals(4L));
    }
    ...
    void findAllByUserId_NonExistingUserId_ReturnsEmptyPage() {
        // When
        Page<Order> actual = orderRepository.findAllByUserId(999L, Pageable.ofSize(5));
